...
const handleShare = () => {
  ...
  if (isQQ) {
    ...
    setShareInfo({
      ...
      url: 'https://q-qtest.vercel.app/' // 分享链接（使用当前页面URL）
    })
...
<template>
  <div class="container">
      ...
      <div class="qr-code">
          <img src="https://api.qrserver.com/v1/create-qr-code/?size=180x180&data=https://q-qtest.vercel.app/" alt="QQ分享二维码">
