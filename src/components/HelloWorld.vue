...
const handleShare = () => {
  ...
  if (isQQ) {
    ...
    setShareInfo({
      ...
      url: 'https://q-qtest-hyvins-projects.vercel.app/' // 分享链接（使用当前页面URL）
    })
...
onMounted(() => {
  ...
  if (isQQ) {
    setShareInfo({
      ...
      url: 'https://q-qtest-hyvins-projects.vercel.app/'
    })
  }
})
</script>
...
<template>
  <div class="container">
      ...
      <div class="qr-code">
          <img src="https://api.qrserver.com/v1/create-qr-code/?size=180x180&data=https://q-qtest-hyvins-projects.vercel.app/" alt="QQ分享二维码">
...
<style>
    * {
    ...
    .share-btn {
        ...
        cursor: pointer;
        margin: 30px 0;
        box-shadow: 0 6px 20px rgba(198, 113, 237, 0.5);
    ...
    .share-btn:hover {
        ...
        box-shadow: 0 8px 25px rgba(198, 113, 237, 0.7);
    }
